        ...
        (function (Context) {
            var Device = (function () {
                ...
                Device.prototype.getOsInfo = function (appVersion) {
                    ...
                    var check = function (str) { return appVersion.indexOf(str) !== -1; };
                    if (appVersion) {
                        if (check("Win")) {
            ...
            var Session = (function () {
                ...
                function Session(config) {
                    ...
                    if (!(typeof config.sessionExpirationMs === "function")) {
                        config.sessionExpirationMs = function () { return Session.acquisitionSpan; };
                    }
                    if (!(typeof config.sessionRenewalMs === "function")) {
                        config.sessionRenewalMs = function () { return Session.renewalSpan; };
                    }
                    this.config = config;
                ...
                Session.acquisitionSpan = 24 * 60 * 60 * 1000; // 24 hours
                Session.renewalSpan = 30 * 60 * 1000; // 30 minutes
                return Session;
            })();
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var _ExceptionStackFrame = (function () {
                ...
                _ExceptionStackFrame.baseSize = 58; //'{"method":"","level":,"assembly":"","fileName":"","line":}'.length
        ...
        (function (Telemetry) {
            var Metric = (function (_super) {
                ...
                function Metric(name, value, count, min, max) {
                    var type = "A"; // per PM this is always aggregated
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    maxPayloadSizeInBytes: function () { return _this.config.maxPayloadSizeInBytes; },
