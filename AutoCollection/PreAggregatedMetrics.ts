...
export class AutoCollectPreAggregatedMetrics {
    ...
    public enable(isEnabled: boolean, collectionInterval?: number) {
        ...
        if (isEnabled) {
            if (!this._handle) {
                ...
                this._handle = setInterval(() => this._trackPreAggregatedMetrics(), this._collectionInterval);
    ...
    public countException(dimensions: IMetricExceptionDimensions) {
        ...
        let counter: AggregatedMetricCounter = this._getAggregatedCounter(dimensions, this._exceptionCountersCollection);
        counter.totalCount++;
    }
    ...
    public countTrace(dimensions: IMetricTraceDimensions) {
        ...
        let counter: AggregatedMetricCounter = this._getAggregatedCounter(dimensions, this._traceCountersCollection);
        counter.totalCount++;
    }
    ...
    private _getAggregatedCounter(dimensions: IMetricBaseDimensions, counterCollection: Array<AggregatedMetricCounter>): AggregatedMetricCounter {
        let notMatch = false;
