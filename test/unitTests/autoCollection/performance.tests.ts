...
import { NativeMetricsCounter, PerformanceCounter } from "../../../src/autoCollection/metrics/types";
...
describe("PerformanceCounterMetricsHandler", () => {
    ...
    describe("#Metrics", () => {
        ...
        it("should observe instruments during collection", async () => {
            ...
            assert.equal(metrics[6].descriptor.name, NativeMetricsCounter.GARBAGE_COLLECTION_SCAVENGE);
            assert.equal(metrics[7].descriptor.name, NativeMetricsCounter.GARBAGE_COLLECTION_SWEEP_COMPACT);
            assert.equal(metrics[8].descriptor.name, NativeMetricsCounter.GARBAGE_COLLECTION_INCREMENTAL_MARKING);
