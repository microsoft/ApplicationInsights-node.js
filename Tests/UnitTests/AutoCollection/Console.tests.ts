...
import {
  enable,
  dispose as disable,
} from "../../../src/autoCollection/diagnostic-channel/console.sub";
...
describe("AutoCollection/Console", () => {
  ...
  describe("#init and #dispose()", () => {
    it("init should enable and dispose should stop console auto collection", () => {
      var appInsights = AppInsights.setup(
        "1aa11111-bbbb-1ccc-8ddd-eeeeffff3333"
      ).setAutoCollectConsole(true);
      var enableConsoleRequestsSpy = sinon.spy(
      ...
      assert.equal(
        ...
        1,
        "enable should be called once as part of console auto collection initialization"
      );
      ...
      assert.equal(
        enableConsoleRequestsSpy.callCount,
        2,
        "enable(false) should be called once as part of console auto collection shutdown"
      );
