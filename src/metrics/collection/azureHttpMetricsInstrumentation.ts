        ...
        return function outgoingRequest(
            ...
            request.prependListener(
                ...
                (response: http.IncomingMessage & { aborted?: boolean; complete?: boolean }) => {
                    ...
                    metric.attributes[SemanticAttributes.NET_PEER_PORT] = String(
                        response.socket.remotePort
                    );
                    metric.attributes[SemanticAttributes.HTTP_STATUS_CODE] = String(
                        response.statusCode
                    );
    ...
    private _incomingRequestFunction(
        ...
        return function incomingRequest(this: unknown, event: string, ...args: unknown[]): boolean {
            ...
            response.end = function (this: http.ServerResponse, ..._args: any) {
                ...
                metric.attributes[SemanticAttributes.NET_HOST_PORT] = String(
