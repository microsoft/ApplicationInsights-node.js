...
export class RequestMetrics {
    ...
    constructor(meter: Meter, httpMetrics: AzureHttpMetricsInstrumentation) {
        ...
        this._requestRateGauge = this._meter.createObservableGauge(MetricName.REQUEST_RATE, { description: "Incoming Requests Average Execution Time", valueType: ValueType.DOUBLE });
        this._requestFailureRateGauge = this._meter.createObservableGauge(MetricName.REQUEST_FAILURE_RATE, { description: "Incoming Requests Failed Rate", valueType: ValueType.DOUBLE })
